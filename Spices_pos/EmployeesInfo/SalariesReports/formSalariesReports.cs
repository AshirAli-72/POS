...
{
    public partial class formSalariesReports : Form
    {
        ...
        {
            lblReportTitle.Text = "Date Wise Salary Report";
            reportType = 0;
            ...
            GetSetData.FillComboBoxWithValues("select * from pos_employees;", "full_name", txtEmployeeName);
            GetSetData.FillComboBoxWithValues("select * from pos_employees;", "emp_code", txtEmployeeCode);
        ...
        private void formSalariesReports_Load(object sender, EventArgs e)
        {
            try
            {
                refresh();
        ...
        private void btn_bill_wise_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                lblReportTitle.Text = "Employee Wise Salary Report";
                reportType = 1;
        ...
        private void DisplayDateWiseReportInReportViewer(ReportViewer viewer)
        {
            try
            {
                this.ReportProcedureDateWiseSalaryDetailsTableAdapter.Fill(this.salariesPayments_ds.ReportProcedureDateWiseSalaryDetails, FromDate.Text, ToDate.Text);
                this.ReportProcedureReportsTitlesTableAdapter.Fill(this.salariesPayments_ds.ReportProcedureReportsTitles);
        ...
        private void DisplayStatusWiseReportInReportViewer(ReportViewer viewer)
        {
            try
            {
                this.ReportProcedureEmployeeWiseSalaryDetailsTableAdapter.Fill(this.salariesPayments_ds.ReportProcedureEmployeeWiseSalaryDetails, FromDate.Text, ToDate.Text, txtEmployeeName.Text, txtEmployeeCode.Text);
                this.ReportProcedureReportsTitlesTableAdapter.Fill(this.salariesPayments_ds.ReportProcedureReportsTitles);
                viewer.SetDisplayMode(Microsoft.Reporting.WinForms.DisplayMode.PrintLayout);
                DisplayReportInReportViewer(viewer);
                viewer.RefreshReport();
