...
ALTER view [dbo].[CounterDealIndividualItems]
as
...
ALTER view [dbo].[ReportViewBillWiseCounterReturns]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ReportViewBillWiseSales]
as
...
ALTER view [dbo].[ReportViewBillWiseSalesReturns]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[reportViewPrintTicket]
as
...
ALTER view [dbo].[ViewBankDetails]
as
...
ALTER view [dbo].[ViewBankLoanDetails]
as
...
ALTER view [dbo].[ViewBankLoanPaybookDetails]
...
ALTER view [dbo].[ViewCapitalHistoryDetails]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewCashOutDetails]
as
...
ALTER View [dbo].[ViewCharityDetails]
as
...
ALTER view [dbo].[ViewClockInDetails]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewCounterCashDeals]
as
...
ALTER view [dbo].[ViewCounterCashGroupedIndividualItems]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewCounterCashGroupedItems] 
as
...
ALTER view [dbo].[ViewCounterCashRegularItems]
as
...
ALTER view [dbo].[ViewCounterSaleCategoryWiseItems]
as
...
ALTER view [dbo].[ViewCounterSaleRegularItems]
as
...
ALTER View [dbo].[ViewCustomerDuesDetails]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewCustomerLastReceipt]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewCustomerRecoveryDetails]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewCustomerSalesReturnLastReceipt]
...
ALTER view [dbo].[ViewCustomersDetails]
as
...
ALTER view [dbo].[ViewCustomerWiseOrders]
as
...
ALTER view [dbo].[ViewCustomerWiseRecovery]
...
ALTER view [dbo].[ViewDateWiseOrderReturned]
as
...
ALTER view [dbo].[ViewDateWiseOrdersSold]
as
...
ALTER view [dbo].[ViewDealDetails]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewEmployeeCommission]
...
ALTER view [dbo].[ViewEmployeeSalariesDetails]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewEmployeesDetails]
as
...
ALTER view [dbo].[ViewExpensesDetails]
...
ALTER view [dbo].[ViewExpiredItems]
as
...
ALTER View [dbo].[ViewGranterDetails]
as
...
ALTER view [dbo].[ViewGroupedItems]
as
...
ALTER view [dbo].[ViewInstallmentAccountDetails]
as
...
ALTER view [dbo].[ViewInventoryHistory]
as
...
ALTER view [dbo].[ViewInvestorDetails]
as
...
ALTER View [dbo].[ViewInvestorPaybookDetails]
as
...
ALTER View [dbo].[ViewInvestorPaymentsDetails]
as
...
ALTER view [dbo].[ViewLoanGivenDetails]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewOrdersReturned]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewOverAllOrders]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewProductStocks]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewPromoGroupItems]
as
...
ALTER view [dbo].[ViewPurchaseReturnDetails]
as
...
ALTER view [dbo].[ViewPurchasingDetails]
as
...
ALTER view [dbo].[ViewReturnPricesAdjustments]
as
...
ALTER view [dbo].[ViewSalesPricesAdjustments]
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewShelfGouping]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER  view [dbo].[ViewStockDetails]
as
...
ALTER view [dbo].[ViewStoreEndDay]
...
ALTER View [dbo].[ViewSupplierDetails]
as
...
ALTER view [dbo].[ViewSupplierPaybookDetails]
as
...
ALTER view [dbo].[ViewSupplierPaymentDetails]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewTicketHistory]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER view [dbo].[ViewTopSellingProducts]
as
...
ALTER View [dbo].[ViewUnholdItems]
as
...
ALTER View [dbo].[ViewWholeInventory]
as
...
ALTER procedure [dbo].[DashboardProcedureGetCountForAvailableCheques]
(
	@Date date,
	@Date2 date,
	@result float output
...
ALTER procedure [dbo].[DashboardProcedureGetCountForDefaulters]
(
	@Date date,
	@result float output
)
...
ALTER procedure [dbo].[DashboardProcedureGetCountForExpiredInventory]
(
	@Date date,
	@result float output
)
...
ALTER procedure [dbo].[DashboardProcedureGetCountForLowInventory]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfAssetsAmount]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfBankBalance]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfDuesAmount]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfExpenses]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfExpiredItems]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfLowInventory]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfPayablesAmount]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfPurchases]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfReceivablesAmount]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfReturnItems]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfSoldItems]
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfStock] 
...
ALTER procedure [dbo].[DashboardProcedureGetSumOfSupplierPayments]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[DashboardProcedureGetSumWithdrawBankBalance]
(
	@result float output
)
AS
...
ALTER procedure [dbo].[fillComboBoxAccountTitle]
as
...
ALTER procedure [dbo].[fillComboBoxBankAccountNo]
as
...
ALTER procedure [dbo].[fillComboBoxBankTitle]
as
...
ALTER procedure [dbo].[fillComboBoxBatchNumbers]
as
...
ALTER procedure [dbo].[fillComboBoxBranchkTitle]
as
...
ALTER procedure [dbo].[fillComboBoxBrand]
as
...
ALTER procedure [dbo].[fillComboBoxCategory]
as
...
ALTER procedure [dbo].[fillComboBoxCityNames]
as
...
ALTER procedure [dbo].[fillComboBoxColors]
as
...
ALTER procedure [dbo].[fillComboBoxCounters]
as
...
ALTER procedure [dbo].[fillComboBoxCounterSalesItems]
as
...
ALTER procedure [dbo].[fillComboBoxCountryNames]
as
...
ALTER procedure [dbo].[fillComboBoxCustomerNames]
as
...
ALTER procedure [dbo].[fillComboBoxEmployeeNames]
as
...
ALTER procedure [dbo].[fillComboBoxExpenseTitle]
as
...
ALTER procedure [dbo].[fillComboBoxInstallmentMonths]
as
...
ALTER procedure [dbo].[fillComboBoxInvestorsNames]
as
...
ALTER procedure [dbo].[fillComboBoxInvoicesNumbers]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[fillComboBoxLoanBankTitles]
as
...
ALTER procedure [dbo].[fillComboBoxLoanHolders]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[fillComboBoxNamesLoanDetails]
as
...
ALTER procedure [dbo].[fillComboBoxProductNames]
as
...
ALTER procedure [dbo].[fillComboBoxPromoGroups]
as
...
ALTER procedure [dbo].[fillComboBoxRoles]
as
...
ALTER procedure [dbo].[fillComboBoxShelfItems]
as
...
ALTER procedure [dbo].[fillComboBoxShifts]
as
...
ALTER procedure [dbo].[fillComboBoxSubCategory]
as
...
ALTER procedure [dbo].[fillComboBoxSupplierNames]
as
...
ALTER procedure [dbo].[fillComboBoxTransactionStatus]
as
...
ALTER procedure [dbo].[fillComboBoxTransactionType]
as
...
ALTER procedure [dbo].[fillComboBoxUsers]
as
...
ALTER procedure [dbo].[ProcedureCustomerDuesDetails]
...
ALTER procedure [dbo].[ProcedureCustomerLastReceiptItems]
(
	@search nvarchar(50)
 )
as 
...
-- Enanbled Available Stock Details
ALTER procedure [dbo].[ProcedureCustomerLastReceiptReturnItems]
(
	@search nvarchar(50)
 )
as 
...
ALTER procedure [dbo].[ProcedureCustomersDetails]
as 
...
ALTER procedure [dbo].[ProcedureDateWiseLoanDetails]
(
...
ALTER procedure [dbo].[ProcedureDealItemsList]
(
	@search nvarchar(50)
)
...
ALTER procedure [dbo].[ProcedureDemandItems]
(
	@search nvarchar(50)
)
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[ProcedureEmployeeCommissionDetails]
(
	@search nvarchar(50)
)
...
ALTER PROCEDURE [dbo].[ProcedureGeneralSettings]
(
    @value NVARCHAR(50),
...
ALTER PROCEDURE [dbo].[ProcedureGetButtonAuthorities1]
(
...
ALTER PROCEDURE [dbo].[ProcedureGetDashboardAuthorities]
(
    @value NVARCHAR(50), -- Parameter to pass the column name
    @searchValue NVARCHAR(50),
    @result NVARCHAR(50) OUTPUT
...
ALTER PROCEDURE [dbo].[ProcedureGetIntergerValues]
(   
...
ALTER PROCEDURE [dbo].[ProcedureGetNumericValues]
(   
    @columnName NVARCHAR(50),
    @tableName NVARCHAR(50),
    @condition NVARCHAR(50),
...
ALTER Procedure [dbo].[ProcedureGetReportsAuthorities]
(
    @value NVARCHAR(50), -- Parameter to pass the column name
    @searchValue NVARCHAR(50),
    @result NVARCHAR(50) OUTPUT
...
ALTER PROCEDURE [dbo].[ProcedureGetStringValues]
(   
    @columnName NVARCHAR(50),
    @tableName NVARCHAR(50),
    @condition NVARCHAR(50),
...
ALTER procedure [dbo].[procedureInstallmentPlanDetails]
(
	@search nvarchar(50)
)
as
...
-- Enanbled Available Stock Details
ALTER procedure [dbo].[ProcedureOrderReturnedItemsList]
(
	@search nvarchar(50)
)
as 
...
-- Enanbled Available Stock Details
ALTER procedure [dbo].[ProcedureOrderSoldItemsList]
(
	@search nvarchar(50)
 )
as 
...
-- Show All Products Details
ALTER procedure [dbo].[ProcedureOverallEmployeesDetails]
as 
...
ALTER procedure [dbo].[ProcedurePendingInstallmentDetails]
(
	@search nvarchar(50)
)
as
...
ALTER procedure [dbo].[ProcedureProductSubItems]
(
	@search nvarchar(50)
 )
as 
...
-- Enanbled Available Stock Details
ALTER procedure [dbo].[ProcedurePurchasedItems]
(
	@BillNo nvarchar(50),
...
ALTER procedure [dbo].[ProcedurePurchaseIMEIDetails]
(
	@BillNo nvarchar(50),
	@InvoiceNo nvarchar(50)
)
...
-- Enanbled Available Stock Details
ALTER procedure [dbo].[ProcedurePurchaseReturnDetails]
as 
...
-- Enanbled Available Stock Details
ALTER procedure [dbo].[ProcedurePurchaseReturnItems]
(
	@BillNo nvarchar(50),
	@InvoiceNo nvarchar(50)
 )
...
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[ProcedureQueryResult]
(
    @query NVARCHAR(150),
    @result NVARCHAR(50) OUTPUT
)
...
ALTER procedure [dbo].[ProcedureSearchingUpdateDemandItems]
(
	@BillNo nvarchar(50),
	@InvoiceNo nvarchar(50) 
)
...
ALTER procedure [dbo].[ProcedureSearchingUpdatePurchasingItems]
(
	@BillNo nvarchar(50),
	@InvoiceNo nvarchar(50) 
)
...
ALTER procedure [dbo].[ProcedureStatusWiseLoanDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
	@status nvarchar(50)
...
ALTER procedure [dbo].[procedureTesting] 
...
ALTER procedure [dbo].[ProcedureTicketItemsList]
(
	@search nvarchar(50)
 )
as 
...
-- Enanbled Available Stock Details
ALTER procedure [dbo].[ProcedureUnholdItemsList]
(
	@search nvarchar(50)
 )
as 
...
ALTER procedure [dbo].[ProcedureUpdateDealItems]
(
	@search nvarchar(50)
)
...
ALTER procedure [dbo].[ProcedureUpdateDemandItems]
(
	@search nvarchar(50)
)
as
...
ALTER procedure [dbo].[ProcedureUpdatePurchasingItems]
(
	@search nvarchar(50) 
)
...
ALTER procedure [dbo].[ProcedureUpdatePurchasingReturnItems]
(
	@search nvarchar(50) 
)
...
ALTER procedure [dbo].[ProcedureUserPermissions1]
(
...
-- Select items for Permissions
ALTER procedure [dbo].[ProcedureUserPermissions2]
(
	@SearchItem nvarchar(50),
	--@TableName nvarchar(100),
	@role_id int
...
-- Select items for Permissions
ALTER procedure [dbo].[ProcedureUserPermissionsDashboard]
(
	@SearchItem nvarchar(50),
	--@TableName nvarchar(100),
	@role_id int
...
-- Select items for Permissions
ALTER procedure [dbo].[ProcedureUserPermissionsReports]
(
	@SearchItem nvarchar(50),
	--@TableName nvarchar(100),
	@role_id int
...
ALTER Procedure [dbo].[ProcedureViewBankDetails]
as
...
ALTER procedure [dbo].[ProcedureViewCounterSaleCategoryWiseItems]
as
...
ALTER procedure [dbo].[ProcedureViewCounterSaleRegularItems]
as
...
ALTER procedure [dbo].[ProcedureViewGroupedItems]
as 
...
ALTER Procedure [dbo].[ReporProcedureBillWiseCounterReturns]
(
	@BillNo nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureAgreementForm]
(
	@billNo nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureAgreementFormChequeDetails]
(
	@billNo nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureAgreementFormContractPolicies]
as
...
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[ReportProcedureAgreementFormGurantors]
(
	@billNo nvarchar(50)
)
as
...
ALTER procedure [dbo].[ReportProcedureBankWiseChequeDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureBankWiseLoanDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureBankWiseLoanPaybookDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
	@bankName nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureBatchWiseCustomerDues]
(
	@batchNo nvarchar(50)
)
as
...
ALTER procedure [dbo].[ReportProcedureBatchWiseInvoices]
(
	@batchNo nvarchar(50),
	@toDate nvarchar(50),
	@fromDate nvarchar(50)
...
ALTER procedure [dbo].[ReportProcedureBillWiseChequeDetails]
(
	@billNo nvarchar(50)
...
SET QUOTED_IDENTIFIER ON
GO
ALTER Procedure [dbo].[ReportProcedureBillWiseSales] 
(
	@BillNo nvarchar(50)
)
...
ALTER Procedure [dbo].[ReportProcedureBillWiseTotalMarketPrice] 
(
	@BillNo nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureBouncedChequeNotifications]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureCharityDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureCityWiseCustomerDues]
(
	@city nvarchar(50)
)
as
...
ALTER Procedure [dbo].[ReportProcedureCounterSalesLastCredits]
(
...
ALTER procedure [dbo].[ReportProcedureCountryWiseCustomerDues]
(
	@country nvarchar(50)
)
as
...
ALTER Procedure [dbo].[ReportProcedureCountryWiseInvestorsList]
(
	@country nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureCountryWiseInvoices]
(
	@country nvarchar(50),
	@toDate nvarchar(50),
	@fromDate nvarchar(50)
...
ALTER procedure [dbo].[ReportProcedureCustomerInstallmentStatement]
(
	@billNo nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureCustomerWiseChequeDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureCustomerWiseInvoices]
(
	@customer nvarchar(50),
	@code nvarchar(50),
	@toDate nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureCustomerWiseRecoveries]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
	@customerName nvarchar(50),
...
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[ReportProcedureDateWiseCapitalHistoryDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureDateWiseIMEIDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureDateWiseInvestorsPayments]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureDateWiseLoanDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureDateWiseLoanPaybookDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureDateWisePaymentDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureDateWiseRecoveries]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureDateWiseSalaryDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(20)
)
...
ALTER procedure [dbo].[ReportProcedureDateWiseSalesReturnSummary]
(
	@fromDate nvarchar(50),
	@ToDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureDateWiseSalesSummary]
(
	@fromDate nvarchar(50),
	@ToDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureDeals]
(
...
ALTER procedure [dbo].[ReportProcedureEmployeeWiseSalaryDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureGurantorsBatchNoWise]
(
	@BatchNo nvarchar(50)
)
as
...
ALTER procedure [dbo].[ReportProcedureGurantorsBillWise]
(
	@BillNo nvarchar(50)
)
as
...
ALTER procedure [dbo].[ReportProcedureGurantorsCustomerWise]
(
	@customerName nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureGurantorsOverallDetails]
as
...
ALTER procedure [dbo].[ReportProcedureInstallmentDefaultersList]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureInvestorPaybookReceipt]
(
	@date nvarchar(50),
	@time nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureInvestorWisePayments]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureInvoiceWiseIMEIDetails]
(
	@invoiceNo nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureItemsWiseIMEIDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureNameWiseLoanDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureOverAllCustomerDues]
...
ALTER procedure [dbo].[ReportProcedureOverAllInvestorPayments]
...
ALTER procedure [dbo].[ReportProcedureOverAllInvestorsList]
...
ALTER procedure [dbo].[ReportProcedureOverAllRecoveries]
(
	@customerName nvarchar(50),
	@code nvarchar(50)
)
...
ALTER Procedure [dbo].[ReportProcedureProvinceWiseInvestorsList]
(
...
ALTER procedure [dbo].[ReportProcedureProvinceWiseInvoices]
(
	@province nvarchar(50),
	@toDate nvarchar(50),
	@fromDate nvarchar(50)
...
SET QUOTED_IDENTIFIER ON
GO
ALTER Procedure [dbo].[ReportProcedureReportsTitles]
...
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[ReportProcedureSalaryReceipt]
(
	@date nvarchar(50),
	@time nvarchar(20)
)
...
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[ReportProcedureStatusCapitalHistoryDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
	@status nvarchar(50)
...
ALTER procedure [dbo].[ReportProcedureStatusWiseChequeDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
	@status nvarchar(50)
...
ALTER procedure [dbo].[ReportProcedureStatusWiseIMEIDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
	@status nvarchar(50)
...
ALTER Procedure [dbo].[ReportProcedureStatusWiseInvestorsList]
(
	@status nvarchar(50)
)
...
ALTER procedure [dbo].[ReportProcedureSupplierWiseIMEIDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedureSupplierWisePaymentDetails]
(
	@fromDate nvarchar(50),
	@toDate nvarchar(50),
	@supplierTitle nvarchar(50),
...
ALTER procedure [dbo].[ReportProcedurModifyChequeDetails]
(
	@search nvarchar(50)
)
