...
{
    public partial class new_purchase_a6_report : Form
    {
        ...
        private void fun_new_purchase_a6_report()
        {
            try
            {              
        ...
        private void new_purchase_a6_report_Load(object sender, EventArgs e)
        {
            try
            {
                fun_new_purchase_a6_report();
            }
            catch (Exception es)
            {
                error.errorMessage(es.Message);
