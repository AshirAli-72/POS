...
{
    public partial class form_bank_title : Form
    {
        ...
        {
            GetSetData.FillComboBoxUsingProcedures(title_text, "fillComboBoxBankTitle", "bank_title");
        }
        ...
        private void insert_records()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"insert into pos_bank (bank_title) values ('" + title_text.Text.ToString() + "');";
        ...
        {
            //GetSetData.SaveLogHistoryDetails("Bank Title Form", "Exit...", role_id);
            this.Close();
        }
        ...
        private bool DeleteItems()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"delete from pos_bank where bank_title = '" + title_text.Text + "';";
                    data.insertUpdateCreateOrDelete(GetSetData.query);

                    //GetSetData.SaveLogHistoryDetails("Bank Title Form", "Deleting item [" + title_text.Text + "]", role_id);
                }
                else
                {
        ...
        private void form_bank_title_Load(object sender, EventArgs e)
        {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"update pos_bank set bank_title = '" + title_text.Text.ToUpper() + "' where (bank_title = '" + title + "');";
                    data.insertUpdateCreateOrDelete(GetSetData.query);
