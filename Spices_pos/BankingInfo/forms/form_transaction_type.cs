...
{
    public partial class form_transaction_type : Form
    {
        ...
        {
            GetSetData.FillComboBoxUsingProcedures(title_text, "fillComboBoxTransactionType", "transaction_type");
        }
        ...
        private void insert_records()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"insert into pos_transaction_type (transaction_type) values ('" + title_text.Text.ToString() + "');";
        ...
        {
            //GetSetData.SaveLogHistoryDetails("Bank Transaction Type Form", "Exit...", role_id); 
            this.Close();
        }
        ...
        private bool DeleteItems()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"delete from pos_transaction_type where transaction_type = '" + title_text.Text + "';";
                    data.insertUpdateCreateOrDelete(GetSetData.query);

                    //GetSetData.SaveLogHistoryDetails("Bank Transaction Type Form", "Deleting item [" + title_text.Text + "]", role_id);
                }
                else
                {
        ...
        private void form_transaction_type_Load(object sender, EventArgs e)
        {
            GetSetData.addFormCopyrights(lblCopyrights);
            ClassDefaultValuesSetInDB.InsertValuesInTablesBankTransactionType();
            RefreshFieldTransactionType();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"update pos_transaction_type set transaction_type = '" + title_text.Text.ToUpper() + "' where (transaction_type = '" + title + "');";
                    data.insertUpdateCreateOrDelete(GetSetData.query);
