...
{
    public partial class formBankLoanPaymentsReport : Form
    {
        ...
        public formBankLoanPaymentsReport()
        {
            InitializeComponent();
        }
        ...
        {
            lblReportTitle.Text = "Date Wise Loan Payment Report";
            reportType = 0;
        ...
        private void formBankLoanPaymentsReport_Load(object sender, EventArgs e)
        {
            try
            {
                refresh();
        ...
        private void btn_bill_wise_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                lblReportTitle.Text = "Bank Wise Loan Payment Report";
                reportType = 1;
        ...
        private void DisplayDateWiseReportInReportViewer(ReportViewer viewer)
        {
            try
            {
                this.ReportProcedureDateWiseLoanPaybookDetailsTableAdapter.Fill(this.bankLoanPayments_ds.ReportProcedureDateWiseLoanPaybookDetails, FromDate.Text, ToDate.Text);
                this.ReportProcedureReportsTitlesTableAdapter.Fill(this.bankLoanPayments_ds.ReportProcedureReportsTitles);
        ...
        private void DisplayStatusWiseReportInReportViewer(ReportViewer viewer)
        {
            try
            {
                this.ReportProcedureBankWiseLoanPaybookDetailsTableAdapter.Fill(this.bankLoanPayments_ds.ReportProcedureBankWiseLoanPaybookDetails, FromDate.Text, ToDate.Text, txtEmployeeName.Text, txtEmployeeCode.Text);
                this.ReportProcedureReportsTitlesTableAdapter.Fill(this.bankLoanPayments_ds.ReportProcedureReportsTitles);
                viewer.SetDisplayMode(Microsoft.Reporting.WinForms.DisplayMode.PrintLayout);
                DisplayReportInReportViewer(viewer);
                viewer.RefreshReport();
