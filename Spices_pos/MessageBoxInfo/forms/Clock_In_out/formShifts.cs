    ...
    public partial class formShifts : Form
    {
        ...
        private void insert_records()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"insert into pos_shift (title) values ('" + title_text.Text.ToString() + "');";
                    data.insertUpdateCreateOrDelete(GetSetData.query);

                    //GetSetData.SaveLogHistoryDetails("Add New Country Title Form", "Saving Country [" + title_text.Text + "]", role_id);
        ...
        private bool DeleteItems()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = "delete from pos_shift where title = '" + title_text.Text + "';";
                    data.insertUpdateCreateOrDelete(GetSetData.query);
        ...
        {
            GetSetData.FillComboBoxUsingProcedures(title_text, "fillComboBoxShifts", "title");
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"update pos_shift set title = '" + title_text.Text.ToUpper() + "' where (title = '" + title + "');";
                    data.insertUpdateCreateOrDelete(GetSetData.query);
