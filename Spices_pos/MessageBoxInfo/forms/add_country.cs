    ...
    public partial class add_country : Form
    {
        ...
        private void insert_records()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"insert into pos_country (title) values ('" + title_text.Text.ToString() + "');";
        ...
        private bool DeleteItems()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = "delete from pos_country where title = '" + title_text.Text + "';";
                    data.insertUpdateCreateOrDelete(GetSetData.query);
        ...
        {
            GetSetData.FillComboBoxUsingProcedures(title_text, "fillComboBoxCountryNames", "title");
        }
