    ...
    public partial class addGroup : Form
    {
        ...
        private void insert_records()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = @"insert into pos_promo_groups (title) values ('" + title_text.Text.ToString() + "');";
        ...
        private bool DeleteItems()
        {
            try
            {
                if (title_text.Text != "")
                {
                    GetSetData.query = "delete from pos_promo_groups where title = '" + title_text.Text + "';";
                    data.insertUpdateCreateOrDelete(GetSetData.query);
        ...
        private void FillComboBoxWithItems()
        {
            try
            {
                ...
                GetSetData.FillComboBoxWithValues("select * from pos_promo_groups;", "title", title_text);
            }
            catch (Exception es)
            {
                error.errorMessage(es.Message);
