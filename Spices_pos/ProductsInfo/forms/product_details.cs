    ...
    public partial class product_details : Form
    {
        ...
        private void system_user_permissions()
        {
            try
            {
                ...
                pnl_print.Visible = bool.Parse(buttonPermissions2.ReadFieldByRoleId(role_id, "products_details_print"));
                pnl_delete.Visible = bool.Parse(buttonPermissions2.ReadFieldByRoleId(role_id, "products_details_delete"));
                pnl_add_new.Visible = bool.Parse(buttonPermissions2.ReadFieldByRoleId(role_id, "products_details_new"));
                //pnl_modify.Visible = bool.Parse(data.UserPermissions("products_details_modify", "pos_tbl_authorities_button_controls2", role_id));
                pnl_regular_items.Visible = bool.Parse(buttonPermissions2.ReadFieldByRoleId(role_id, "products_details_regular"));
                btn_expired_items.Visible = bool.Parse(buttonPermissions2.ReadFieldByRoleId(role_id, "products_expired"));
                discountValue = generalSettings.ReadField("discountType");
